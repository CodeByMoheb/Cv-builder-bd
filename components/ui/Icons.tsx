...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L10 12l-2.293 2.293a1 1 0 01-1.414 0L4 12m13 8l-2.293-2.293a1 1 0 00-1.414 0L12 19l2.293 2.293a1 1 0 001.414 0L18 19m-7-3a1 1 0 001.414 0L17 10.707l2.293 2.293a1 1 0 001.414 0L21 12m-4-4l-2.293-2.293a1 1 0 00-1.414 0L12 8" />
  </svg>
);
