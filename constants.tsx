...
export const TEMPLATE_CATEGORIES: TemplateCategory[] = [
    {
        name: 'Modern & Clean',
        templates: [
            // FIX: Added required 'type' property to all templates.
            { id: 'modern', name: 'Modern', component: ModernTemplate, hasPhoto: true, type: 'react' },
            { id: 'sidebar', name: 'Sidebar', component: SidebarTemplate, hasPhoto: true, type: 'react' },
            { id: 'clean-header', name: 'Clean Header', component: CleanHeaderTemplate, hasPhoto: true, type: 'react' },
            { id: 'sharp', name: 'Sharp', component: SharpTemplate, hasPhoto: true, type: 'react' },
            { id: 'tech', name: 'Tech', component: TechTemplate, hasPhoto: false, type: 'react' },
            { id: 'minimalist', name: 'Minimalist', component: MinimalistTemplate, hasPhoto: false, type: 'react' },
            { id: 'swiss', name: 'Swiss', component: SwissTemplate, hasPhoto: false, type: 'react' },
            { id: 'grid', name: 'Grid-Based', component: GridTemplate, hasPhoto: false, type: 'react' },
            { id: 'bold-header', name: 'Bold Header', component: BoldHeaderTemplate, hasPhoto: false, type: 'react' },
        ],
    },
    {
        name: 'Professional & Corporate',
        templates: [
            { id: 'executive', name: 'Executive', component: ExecutiveTemplate, hasPhoto: true, type: 'react' },
            { id: 'professional', name: 'Professional', component: ProfessionalTemplate, hasPhoto: true, type: 'react' },
            { id: 'corporate', name: 'Corporate', component: CorporateTemplate, hasPhoto: true, type: 'react' },
            { id: 'elegant', name: 'Elegant', component: ElegantTemplate, hasPhoto: true, type: 'react' },
            { id: 'data-driven', name: 'Data-Driven', component: DataDrivenTemplate, hasPhoto: false, type: 'react' },
            { id: 'corporate-blue', name: 'Corporate Blue', component: CorporateTemplate, hasPhoto: true, type: 'react' },
            { id: 'classic-serif', name: 'Classic Serif', component: ClassicTemplate, hasPhoto: false, type: 'react' },
        ],
    },
    {
        name: 'Creative & Visual',
        templates: [
            { id: 'creative', name: 'Creative', component: CreativeTemplate, hasPhoto: true, type: 'react' },
            { id: 'impactful', name: 'Impactful', component: ImpactfulTemplate, hasPhoto: true, type: 'react' },
            { id: 'vibrant', name: 'Vibrant', component: VibrantTemplate, hasPhoto: true, type: 'react' },
            { id: 'monogram', name: 'Monogram', component: MonogramTemplate, hasPhoto: true, type: 'react' },
            { id: 'portfolio', name: 'Portfolio', component: PortfolioTemplate, hasPhoto: true, type: 'react' },
            { id: 'gallery', name: 'Gallery', component: GalleryTemplate, hasPhoto: true, type: 'react' },
            { id: 'infographic', name: 'Infographic', component: InfographicTemplate, hasPhoto: true, type: 'react' },
            { id: 'geographic', name: 'Geographic', component: GeographicTemplate, hasPhoto: false, type: 'react' },
            { id: 'timeline', name: 'Timeline', component: TimelineTemplate, hasPhoto: false, type: 'react' },
            { id: 'two-tone', name: 'Two-Tone', component: TwoToneTemplate, hasPhoto: false, type: 'react' },
            { id: 'creative-dark', name: 'Creative Dark', component: CreativeTemplate, hasPhoto: true, type: 'react' },
        ],
    },
    {
        name: 'Formal & Academic',
        templates: [
            { id: 'classic', name: 'Classic', component: ClassicTemplate, hasPhoto: false, type: 'react' },
            { id: 'academic', name: 'Academic CV', component: AcademicTemplate, hasPhoto: false, type: 'react' },
            { id: 'timeline-formal', name: 'Formal Timeline', component: TimelineTemplate, hasPhoto: false, type: 'react' },
            { id: 'executive-plain', name: 'Plain Executive', component: ExecutiveTemplate, hasPhoto: true, type: 'react' },
        ]
    }
];
